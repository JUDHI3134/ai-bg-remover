  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      ...
      <div className=''>
        ...
        <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa ipsum natus aliquid, <br className='max-sm:hidden'/> deleniti itaque dolorem sed inventore  minima corporis.</p>
        <div>
